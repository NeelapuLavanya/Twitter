...
let db = null; // Corrected variable name
...
app.get("/user/tweets/feed", authenticateToken, async (request, response) => {
  ...
  const userFollowsArray = await db.all(getTweetsFeedQuery);
...
app.get(
  ...
  `;
    const likedUsers = await db.all(getLinkedUsersQuery);
